...
{
    public partial class QuanLyPhimForm : Form
    {
        ...
        private void phimBindingNavigatorSaveItem_Click_2(object sender, EventArgs e)
        {
            this.Validate();
            this.phimBindingSource.EndEdit();
            this.tableAdapterManager.UpdateAll(this.twooneDataSet);
        ...
        private void phimBindingNavigatorSaveItem_Click_3(object sender, EventArgs e)
        {
            this.Validate();
            this.phimBindingSource.EndEdit();
            this.tableAdapterManager.UpdateAll(this.twooneDataSet);
